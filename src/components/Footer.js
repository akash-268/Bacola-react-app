  ...
  return (
    <div className="">
      ...
      <div className="row p-3 border-bottom">
        <div className="col-sm-3  border-end">Everyday fresh products</div>
        <div className="col-sm-3 border-end">
          Free delivery for order over $70
        </div>
        <div className="col-sm-3 border-end">Daily Mega Discounts</div>
        <div className="col-sm-3 border-end">Best price on the market</div>
      </div>
      ...
      <div className="row">
        <div className="col-sm-4 ">8 800 555-55 Working 8:00 - 22:00</div>
        <div className="col-sm-8">
          Download App on Mobile : 15% discount on your first purchase
        </div>
      </div>
    </div>
  );
